...
targets = bi_interp1(sources,length(img_files)*(1-scaling_factor));

for i = 1 : length(img_files)
    retargeted_name = [result_folder,img_folder,'_retargeted/',img_names{i},'.jpg'];
    imwrite(targets{i},retargeted_name,'jpg');
end
