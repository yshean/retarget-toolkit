...
%RGB2LAB Convert an image from RGB to CIE-L*a*b*
%
% function [L, a, b] = RGB2Lab(R, G, B)
...
% and returns an image in the CIE-L*a*b* color space.  RGB values can be
% either between 0 and 1 or between 0 and 255.  Values for L* are in the
% range [0,100] while a* and b* are roughly in the range [-120,120].  The
% output(s) are double.
%
